...
- The repeatable Windows PowerShell 5.1 accessibility script snapshots each existing clipboard format before its copy test and restores the original data afterward. A sentinel-text pass confirmed exact restoration after the test process exited.
